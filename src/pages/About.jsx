  ...
  return (
    <section className='max-container'>
      ...
      <div className='mt-5 flex flex-col gap-3 text-slate-500'>
        <p>MERN Stack Developer based in India, specializing in technical education through hands-on learning and building applications.</p>
      </div>
      ...
      <div className='py-10 flex flex-col'>
        ...
        <div className='py-10 mt-20'>
          ...
          <div className='mt-5 flex flex-col gap-3 text-slate-500'>
            <p>
            I have collaborated with few companies, enhancing my skills and working alongside talented professionals. Here's a summary of my experience:
            </p>
          </div>
